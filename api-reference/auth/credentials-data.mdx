...
The Client Data object is used during [user registration](/api-reference/auth/register), [new credential creation](/api-reference/auth/credentials), [login](/api-reference/auth), [recovery](/api-reference/auth/account-recovery) and [action signing](/api-reference/signing-flows)
...
| field     | type     | description                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           |
| --------- | -------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| type      | `string` | `key.create` for <a href="/api-reference/registration-flows">registration</a> and <a href="/api-reference/auth/credentials">new credential</a><br/><code>key.get</code> for <a href="/api-reference/auth">login</a> and <a href="/api-reference/signing-flows">action signing</a> |
...
This attestation data object is used during [registration](/api-reference/registration-flows) and [new credential](/api-reference/auth/credentials).
...
* Encoding: `DER`. See [Signature Format](/developers/guides/generate-a-key-pair#signature-format) for more information
