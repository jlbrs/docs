...
The Client Data object is used during [user registration](/api-reference/auth/register), [new credential creation](/api-reference/auth/credentials), [login](/api-reference/auth), [recovery](/api-reference/auth/account-recovery) and [action signing](/api-reference/auth/signing-flows)
...
| field     | type     | description                                                                                                                                                                                                                                                                                  |
| --------- | -------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| type      | `string` | `key.create` for <a href="/api-reference/auth/registration-flows">registration</a> and <a href="/api-reference/auth/credentials">new credential</a><br /><code>key.get</code> for <a href="/api-reference/auth">login</a> and <a href="/api-reference/auth/signing-flows">action signing</a> |
