---
title: Credentials API data
icon: binary-circle-check
---

## Client Data

The Client Data object is used during [user registration](../../api-docs/authentication/registration/completeuserregistration), [new credential creation](../../api-docs/authentication/credential-management/api-reference/createusercredential-1), [login](../../api-docs/authentication/login/completelogin), [recovery](../../api-docs/authentication/user-recovery/createuserrecovery) and [action signing](../../api-docs/authentication/user-action-signing/completeuseractionsigning)
...
| ----------- | --------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| type        | `string`  | <p> <code>webauthn.create</code> for <a href="../../../api-docs/authentication/registration/completeuserregistration#fido2-credential">registration</a> and <a href="../../../api-docs/authentication/credential-management/api-reference/createusercredential-1#fido2-credential">new credential</a></p><p><code>webauthn.get</code> for <a href="../../../api-docs/authentication/login/completelogin#fido2-credential">login</a> and <a href="../../../api-docs/authentication/user-action-signing/completeuseractionsigning#fido2-credential">action signing</a></p> |
...
| field     | type     | description                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           |
| --------- | -------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| type      | `string` | `key.create` for <a href="../../../api-docs/authentication/registration/completeuserregistration#key-credential">registration</a> and <a href="../../../api-docs/authentication/credential-management/api-reference/createusercredential-1#fido2-credential">new credential</a><br/><code>key.get</code> for <a href="../../../api-docs/authentication/login/completelogin#key-credential">login</a> and <a href="../../../api-docs/authentication/user-action-signing/completeuseractionsigning#key-credential">action signing</a> |
...
This attestation data object is used during [registration](../../api-docs/authentication/registration/completeuserregistration) and [new credential](../../api-docs/authentication/credential-management/api-reference/createusercredential-1).
...
| Field            | Type   | Description                                                                              |
| ---------------- | ------ | ---------------------------------------------------------------------------------------- |
| `clientDataHash` | string | The hex encoded SHA-256 hash of the "stringified" [client data object ](#key-credential) |
...
| Field       | Type   | Description                                                                                                                                                                                                                                                                              |
| ----------- | ------ | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `publicKey` | string | PEM encoded public key that can be used to verify the signature for the credential. This the same public key than the one in the [Credential Info Fingerprint ](#credential-info-fingerprint)object                                                                                      |
| `signature` | string | The signature produced by signing the "stringified" [Credential Info Fingerprint](#credential-info-fingerprint) object with the credentials private key, using the algorithm specified in `algorithm`. Needs to be encoded as a hex string                                               |
...
* Encoding: `DER`. See [Signature Format](../credentials/generate-a-key-pair#signature-format) for more information
