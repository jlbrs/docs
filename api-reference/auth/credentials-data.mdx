...
The Client Data object is used during [user registration](/api-reference/auth/registration-flows), [new credential creation](/api-reference/auth/credentials), [login](/api-reference/auth), [recovery](/api-reference/auth/account-recovery) and [action signing](/api-reference/auth/signing-flows)
...
| ----------- | --------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| type        | `string`  | `webauthn.create` for registration and new credential<br/>`webauthn.get` for login and action signing |
