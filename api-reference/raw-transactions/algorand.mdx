...
| `externalId`  | A unique ID from your system. It can be leveraged to be used as an idempotency key (read more [here](/api-reference/idempotency)). | String _(optional)_ |
