---
title: 'Core API Objects'
description: The following are the core objects (also called entities) that you will interact with when using the Dfns APIs/SDKs.
---
