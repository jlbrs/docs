...
Wallets also support [Delegated Signing](../advanced-topics/delegated-signing), enabling a non-custodial configuration and an "Apple Pay for Crypto" UX via our WebAuthn/Passkeys integrations. If you have feedback on the Wallets API, please send it to [https://support.dfns.co](https://support.dfns.co).
