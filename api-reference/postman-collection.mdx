...
* A pre-request script that handles [User Action Signing](/developers/guides/user-action-signature) for you for every POST requests.

The purpose of the pre-request script is to populate some of the [required headers](/api-reference/request-headers) for authentication. If you're interested in what it does and how it works, you can check the detail of the pre-request script in the collection itself, here:
