...
A first step into solving that was to separate the configuration of whitelisted Passkey domains into its own thing (cf [Passkey Settings - Migration Guide](passkey-settings-migration-guide)).
...
In the end, the consensus within Dfns was to keep pushing in the same direction that was initiated with the [Passkey Settings Migration](passkey-settings-migration-guide) effort: deprecate Applications entirely.
