...
Existing wallets are not impacted. The [Wallets API](../api-docs/wallets) will remain mostly the same except the following endpoints, [delegate](../api-docs/keys/delegate-key), [import](../api-docs/keys/advanced-keys-apis/import-key), [export](../api-docs/keys/advanced-keys-apis/export-key) and [generate signature](../api-docs/keys/generate-signature), are deprecated and migrated to equivalent endpoints in the new [Keys API](../api-docs/keys).
