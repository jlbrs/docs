...
1. Get a challenge from the Dfns system.
    ...
    Related API: ([Get a User Action Challenge](/api-reference/auth/create-user-action-challenge))
...
3. Get back a User Action Signature, and include it with your original API call.
    ...
    Related API: ([Create the User Action Signature](/api-reference/auth/create-user-action-signature))
