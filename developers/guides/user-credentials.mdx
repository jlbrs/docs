...
The user needs to format the challenge into a [Client Data object](../../api-objects#key-credential).

#### Attestation Data

The client data object is then used to build the [Attestation Data object](../../api-objects#key-credential-1).
