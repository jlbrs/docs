...
The user needs to format the challenge into a [Client Data object](/api-reference/auth/credentials-data#client-data).

#### Attestation Data

The client data object is then used to build the [Attestation Data object](/api-reference/auth/credentials-data#attestation-data).
