...
<Frame>![](https://3953120539-files.gitbook.io/~/files/v0/b/gitbook-x-prod.appspot.com/o/spaces%2FtnSPOZGQ2hBmgoVWX5H6%2Fuploads%2Fm5wdfD80IiriWaitkjLj%2FDelegatedSigningDiagram.png?alt=media&#x26;token=50930ca2-f1f4-428b-a60f-ecc9265fec90)</Frame>
...
<Frame>![](https://3953120539-files.gitbook.io/~/files/v0/b/gitbook-x-prod.appspot.com/o/spaces%2FtnSPOZGQ2hBmgoVWX5H6%2Fuploads%2FIhDvNZgu4ZThYoG014JM%2FScreenshot%202023-07-05%20at%203.17.57%20PM.png?alt=media&#x26;token=80bbb46a-9df3-45c5-a0a8-6394b8ae1273)</Frame>
...
For example, Dfns clients can implement "biometric recovery" by encouraging users to [create secondary credentials](/dashboard/registering-a-new-passkey-credential) on alternate devices. In this way, if a user lose access to their primary device (for example, their phone), they can still access their wallet via a secondary device like their laptop.
...
Have a follow up question on Delegated Signing?  Feel free to reach out to us on [https://support.dfns.co](https://support.dfns.co)
