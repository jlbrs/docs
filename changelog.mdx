...
* Launched new endpoint to [create user & wallet simultaneously](/api-reference/auth/register-end-user)
...
* New [network fees](/api-reference/networks/get-fees) API released
...
* Fixed a bug in [BroadcastTransaction](/api-reference/wallets/broadcast-transaction) where the `value` parameter was being interpreted in ETH instead of WEI.
...
* Added [GetAddressForNetwork endpoint](/wallets/get-wallet)
