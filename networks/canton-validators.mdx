...
**Via API:** see details [here](create-validator#sample-request) for the related endpoint to call. 
...
If you are running your own validator, then you can connect it to Dfns over API (see details [here](create-validator#sample-request-1)) or via the Dashboard. Once connected, you can create secure wallets linked to your validator. There is no extra setup needed on your validator side.
...
**Via API:** see details [here](create-validator#sample-request-1) for the related endpoint to call. 
...
Should you need help to create a wallet, you can watch the video above, or follow the tutorial: [using-the-dashboard-create-your-first-wallet](../../getting-started/onboarding-to-dfns/using-the-dashboard-create-your-first-wallet "mention") or use our deditated API doc: [create-wallet](../wallets/create-wallet "mention")
