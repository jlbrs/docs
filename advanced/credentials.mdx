...
The first time you registered on Dfns dashboard, you created a Passkey credential (see how [here](/introduction/quickstart/1-create-your-organization-and-invite-employees)). You can also register additional credentials later on (see how [here](/guides/registering-a-new-passkey-credential)).
