...
* [rule kind `ChainalysisTransactionPrescreening`](../../../api-docs/policy-engine/policies#chainalysistransactionprescreening-policy-rule)
* action kind [`Block`](../../../api-docs/policy-engine/policies#block-policy-action) or [`RequestApproval`](../../../api-docs/policy-engine/policies#requestapproval-policy-action) or [`NoAction`](../../../api-docs/policy-engine/policies#noaction-policy-action)
