...
| :---------------: | :------------------------------------------------------------------------------------------------------------------------------------------ | :------------------------------------------------: | :-------------------------------------------------: | :---------------------------------------------------: |
| <Icon icon="1" /> | [Create your organization and invite employees](/getting-started/onboarding/1-create-your-organization-and-invite-employees)                |                         ✅                         |                         ✅                          |                          ✅                           |
| <Icon icon="2" /> | [Define and Assign permissions](/getting-started/onboarding/2-define-and-assign-permissions)                                                |                         ✅                         |                         ✅                          |                          ✅                           |
| <Icon icon="3" /> | [Create policies](/getting-started/onboarding/3-create-policies)                                                                            |                         ✅                         |                         ✅                          |                          ✅                           |
| <Icon icon="4" /> | [Using the dashboard: create your first wallet](/getting-started/onboarding/4-using-the-dashboard-create-your-first-wallet)                 |                         ✅                         |                         ❌                          |                          ❌                           |
| <Icon icon="5" /> | [Start building: login & create a wallet via API](/getting-started/onboarding/5-start-building-login-and-create-a-wallet-via-api)           |                         ❌                         |                         ✅                          |                          ❌                           |
| <Icon icon="6" /> | [Non-custody 1/2: Dfns API: using a service account](/getting-started/onboarding/6-non-custody-1-2-dfns-api-using-a-service-account)        |                         ❌                         |                         ❌                          |                          ✅                           |
| <Icon icon="7" /> | [Non-custody 2/2: Customer login and delegated wallets](/getting-started/onboarding/7-non-custody-2-2-customer-login-and-delegated-wallets) |                         ❌                         |                         ❌                          |                          ✅                           |
...
<Icon icon="5"/> [Start Building: Login and Create a Wallet via API](/getting-started/onboarding/5-start-building-login-and-create-a-wallet-via-api)
</Card>
