...
There are many ways to authenticate to the Dfns API, you can find all the details on [authentication](/api-reference/auth). In this example we will simply follow the normal [login](/api-reference/auth/flows#regular-user-login-flow) flow.
