...
<Columns cols={2}>
  <Card title="Edit locally" icon="album" href="/development">
...
<Columns cols={2}>
  <Card title="Write with MDX" icon="pencil" href="/essentials/markdown">
...
<Card title="See complete examples" icon="brain" href="https://mintlify.com/customers">
