...
<Steps>
  ...
  <Step title="Assign Permissions">
    Final step! Let's give our user the rights he deserves! We will use the [assign permission](/api-reference/permissions/assign-permission) endpoint to link it to the user we just created
