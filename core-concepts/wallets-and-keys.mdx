...
Wallets also support [Delegated Signing](/core-concepts/non-custodial-wallets), enabling a non-custodial configuration and an "Apple Pay for Crypto" UX via our WebAuthn/Passkeys integrations. 
...
Keys also support [Delegated Signing](/core-concepts/non-custodial-wallets), enabling a non-custodial configuration.
