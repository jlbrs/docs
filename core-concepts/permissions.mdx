...
Start by [Creating a Permission](/api-reference/permissions/create-permission) with some allowed operations in it, and [Assign it](/api-reference/permissions/create-assignment) to a User.
